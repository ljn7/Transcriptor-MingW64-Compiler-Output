...
QT_MOC_LITERAL(5, 40, 11), // "updateFlags"
QT_MOC_LITERAL(6, 52, 12), // "findPrevious"
QT_MOC_LITERAL(7, 65, 8), // "findNext"
QT_MOC_LITERAL(8, 74, 7), // "replace"
QT_MOC_LITERAL(9, 82, 10) // "replaceAll"

    },
    "FindReplaceDialog\0message\0\0text\0timeout\0"
    "updateFlags\0findPrevious\0findNext\0"
    "replace\0replaceAll"
};
...
void FindReplaceDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FindReplaceDialog::message)) {
                *result = 0;
                return;
            }
        }
