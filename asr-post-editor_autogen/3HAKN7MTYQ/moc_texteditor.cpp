...
QT_MOC_LITERAL(5, 33, 11), // "findReplace"
QT_MOC_LITERAL(6, 45, 25), // "updateLineNumberAreaWidth"
QT_MOC_LITERAL(7, 71, 13), // "newBlockCount"
QT_MOC_LITERAL(8, 85, 20), // "highlightCurrentLine"
QT_MOC_LITERAL(9, 106, 20), // "updateLineNumberArea"
QT_MOC_LITERAL(10, 127, 4), // "rect"
QT_MOC_LITERAL(11, 132, 2) // "dy"

    },
    "TextEditor\0message\0\0text\0timeout\0"
    "findReplace\0updateLineNumberAreaWidth\0"
...
void TextEditor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: _t->updateLineNumberArea((*reinterpret_cast< const QRect(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TextEditor::message)) {
                *result = 0;
                return;
            }
        }
