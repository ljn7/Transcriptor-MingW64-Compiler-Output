...
public:
    ...
    void setupUi(QDialog *TagSelectionDialog)
    {
        ...
        QObject::connect(buttonBox, &QDialogButtonBox::accepted, TagSelectionDialog, qOverload<>(&QDialog::accept));
        QObject::connect(buttonBox, &QDialogButtonBox::rejected, TagSelectionDialog, qOverload<>(&QDialog::reject));
