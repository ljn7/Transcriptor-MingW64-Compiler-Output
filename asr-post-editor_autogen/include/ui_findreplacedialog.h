...
public:
    ...
    void setupUi(QDialog *FindReplaceDialog)
    {
        ...
        text_find->setObjectName("text_find");
        ...
        button_find_previous->setObjectName("button_find_previous");
        ...
        button_find_next->setObjectName("button_find_next");
        ...
        text_replace->setObjectName("text_replace");
