...
public:
    ...
    void setupUi(QDialog *ChangeSpeakerDialog)
    {
        if (ChangeSpeakerDialog->objectName().isEmpty())
            ChangeSpeakerDialog->setObjectName("ChangeSpeakerDialog");
        ...
        label_currentSpeaker->setObjectName("label_currentSpeaker");
        ...
        comboBox_speaker->setObjectName("comboBox_speaker");
        ...
        checkBox_changeAllOccurences->setObjectName("checkBox_changeAllOccurences");
        ...
        QObject::connect(buttonBox, &QDialogButtonBox::accepted, ChangeSpeakerDialog, qOverload<>(&QDialog::accept));
        QObject::connect(buttonBox, &QDialogButtonBox::rejected, ChangeSpeakerDialog, qOverload<>(&QDialog::reject));
